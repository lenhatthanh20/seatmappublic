...
<nav aria-label="breadcrumb ">
    <ol class="breadcrumb arr-right bg-dark ">
        ...
        <li class="breadcrumb-item text-light active" aria-current="page">Update Seatmap</li>
    </ol>
</nav>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 m-auto">
                ...
                {* Display errorPOST *}
                {if isset($errorPOST)}
                    {foreach from=$errorPOST item=foo}
                ...
                {* Display errorGET *}
                {if isset($errorGET)}
                    {foreach from=$errorGET item=foo}
                        <div class="alert alert-danger" role="alert">
                            {$foo}
                        </div>
                    {/foreach}
                    ...
                    <div class="form-group">
                        ...
                        <div class="avatar-upload">
                            <div class="avatar-edit">
                                <input type='file' value="{$seatmapPath}" name="fileToUpload" id="fileToUpload" accept=".png, .jpg, .jpeg .gif" />
                                <label for="fileToUpload"></label>
                            </div>
                            <div class="avatar-preview">
                                <div id="imagePreview" data-update="{$seatmapPath}" style="background-image: url({$seatmapPath});">
                                </div>
                            </div>
                        </div>
                    </div>
