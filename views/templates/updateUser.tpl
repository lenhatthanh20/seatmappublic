        ...
        <div class="row">
            <div class="col-md-5 m-auto">
                ...
                <form action="../controllers/updateUser.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="hidden" class="form-control form-control-lg" name="path" value="{$imagePath}"
                               />
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control form-control-lg" placeholder="User Name" name="username" value="{$userName}"
                               />
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control form-control-lg" placeholder="Email" name="email" value="{$email}"
                               />
                    </div>
                    <div class="form-group">
                        ...
                        <div class="avatar-upload">
                            ...
                            <div class="avatar-preview">
                                <div id="imagePreview" data-update="{$imagePath}" style="background-image: url({$imagePath});">
                                </div>
                            </div>
                        </div>
                    </div>
