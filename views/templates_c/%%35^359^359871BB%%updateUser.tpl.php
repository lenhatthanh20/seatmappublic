<?php /* Smarty version 2.6.31, created on 2018-12-07 15:06:35
         compiled from updateUser.tpl */ ?>
<html>
<head>
...
?>
                ...
                <form action="../controllers/updateUser.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="hidden" class="form-control form-control-lg" name="id" value="<?php echo $this->_tpl_vars['id']; ?>
"
                               />
                    </div>
                    <div class="form-group">
                        <input type="hidden" class="form-control form-control-lg" name="path" value="<?php echo $this->_tpl_vars['imagePath']; ?>
"
                               />
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control form-control-lg" placeholder="User Name" name="username" value="<?php echo $this->_tpl_vars['userName']; ?>
"
                               />
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control form-control-lg" placeholder="Email" name="email" value="<?php echo $this->_tpl_vars['email']; ?>
"
                               />
                    </div>
                    <div class="form-group">
                        <div class="alert alert-info">
                            <strong>Note!</strong> If you want to change <strong>user avatar</strong>. You can choose another image.
                        </div>
                        <div class="avatar-upload">
                            ...
                            <div class="avatar-preview">
                                <div id="imagePreview" data-update="<?php echo $this->_tpl_vars['imagePath']; ?>
