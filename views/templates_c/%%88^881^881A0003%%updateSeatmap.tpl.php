<?php /* Smarty version 2.6.31, created on 2018-12-09 11:40:07
         compiled from updateSeatmap.tpl */ ?>
<html>
<head>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 m-auto">
                <h1 class="display-4 text-center">Update Seatmap</h1>
                <p class="lead text-center">This function for administrator</p>

                                <?php if (isset ( $this->_tpl_vars['errorPOST'] )): ?>
                    <?php $_from = $this->_tpl_vars['errorPOST']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
?>
                ...
                <?php endif; ?>
                                ...
                                <?php if (isset ( $this->_tpl_vars['errorGET'] )): ?>
                    <?php $_from = $this->_tpl_vars['errorGET']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['foo']):
?>
                        <div class="alert alert-danger" role="alert">
                            <?php echo $this->_tpl_vars['foo']; ?>
                ...
                <form action="../controllers/updateSeatmap.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="hidden" class="form-control form-control-lg" placeholder="Seatmap id" name="id"
...
"  />
                    ...
                    <div class="form-group">
                        <div class="alert alert-info">
                            <strong>Note!</strong> You can choose another image to change the seatmap.
                        </div>
                        <div class="avatar-upload">
                            <div class="avatar-edit">
                                <input type='file' value="<?php echo $this->_tpl_vars['seatmapPath']; ?>
" name="fileToUpload" id="fileToUpload" accept=".png, .jpg, .jpeg .gif" />
                                <label for="fileToUpload"></label>
                            </div>
                            <div class="avatar-preview">
                                <div id="imagePreview" data-update="<?php echo $this->_tpl_vars['seatmapPath']; ?>
" style="background-image: url(<?php echo $this->_tpl_vars['seatmapPath']; ?>
);">
                                </div>
                            </div>
                        </div>
